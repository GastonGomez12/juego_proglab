...
fondo_galaxia = pygame.image.load("media/fondo.jpg")
...
def iniciar_juego():
    ...
    level = 1 #defino nivel
    vidas = 3 #defino vidas del jugador
    enemigo_eliminado = 0
	#evento de disparo del enemigo
    disparo_enemigo = pygame.USEREVENT + 1
    pygame.time.set_timer(disparo_enemigo, 3000)
    ...
    while running:
        ...
        if len(lista_enemigos) == 0:
            ...
            nave_e3= Enemigo(400, 220, "media/nave_enemiga3.png",200)
