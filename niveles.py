...
fondo_galaxia = pygame.image.load("media/wallpaperflare.com_wallpaper.jpg")




def nivel_2(score, vidas):
    ...
    while running:
        ...
        if len(lista_enemigos) == 0:
            ...
            nave_e2= Enemigo(30, 200, "media/nave_enemiga2.png",100)
            nave_e3= Enemigo(400, 300, "media/nave_enemiga3.png",50)
            nave_e4 = Enemigo(500 , 400,"media/nave_enemiga3.png",100 )
